...
BEGIN
	...
	update fts
	set modify_user = @user, 
		step_notes = @notes,
		assigned_id = @assignedId,
		modify_dttm = getDate() 
	from ft_file_tracker ft
	join ft_file_tracker_step fts
	...
	BEGIN
		...
		BEGIN
			...
			set ack_dttm = getDate(), complete_dttm = getDate()
			...
			values(@fileTrackerId, @newStatusId, null, getDate(),null,null,null,'1',null,@user, getDate(), @user, getDate()) 
